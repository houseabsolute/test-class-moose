...
https://metacpan.org/release/Test-Class-Moose

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Test::Class::Moose
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Test::Class::Moose
...
The code for this distribution is [hosted at GitHub](https://github.com/test-class-moose/test-class-moose).
...
can submit an issue report [via the web](https://github.com/test-class-moose/test-class-moose/issues)
).
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.50.
