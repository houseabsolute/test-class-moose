...
on Linux by [Travis](https://travis-ci.org/houseabsolute/test-class-moose) and on Windows by [AppVeyor](https://ci.appveyor.com/project/autarch/test-class-moose).
