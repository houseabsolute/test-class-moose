...
Since My::Test::Base will not be testing anything itself, we do not put it in
...
choose to only execute the test methods from one or more tags.

XXX: Fill in more about tags.
